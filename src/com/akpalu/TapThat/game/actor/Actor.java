package com.akpalu.TapThat.game.actor;
...
public final class Actor implements Drawable, GameComponent {
	 ...
	 * @param tapThatPic A picture of this actor
	 * @param size The size of the actor
	 */
	public Actor(GameBoard gameBoard, Bitmap tapThatPic, int size) {
		this.gameBoard = gameBoard;
		this.sprite = new Sprite();
		this.sprite.setBitmap(tapThatPic, size);
