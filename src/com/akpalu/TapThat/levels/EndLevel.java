...
import com.akpalu.TapThat.activities.Congratulations;
...
public class EndLevel extends VolumeControlActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TextView tapThatCountView = (TextView) findViewById(R.id.level_end_tapThat_count);
		tapThatCountView.setText(Integer.toString(score) + "/" + level.getTargetScore());
